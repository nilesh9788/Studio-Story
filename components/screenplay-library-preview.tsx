...
export function ScreenplayLibraryPreview() {
  ...
  return (
    <section id="screenplays" className="py-20 px-4 sm:px-6 lg:px-8 bg-background border-t border-border">
      <div className="max-w-6xl mx-auto">
        ...
        <div ref={cardsRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {screenplays.map((screenplay) => (
            <div
              key={screenplay.id}
              className="group p-6 border border-border hover:border-accent bg-background hover:bg-secondary transition-all duration-300 cursor-pointer hover:shadow-lg hover:-translate-y-1"
            >
              <div className="flex items-start justify-between mb-4">
                ...
                <div className="text-right">
                  <p className="text-2xl font-bold text-accent">{screenplay.pages}</p>
                  <p className="text-xs text-muted-foreground">pages</p>
                </div>
              </div>
              <div className="flex items-center justify-between pt-4 border-t border-border">
                <span className="text-sm text-muted-foreground">{screenplay.year}</span>
                <span className="text-accent font-semibold text-sm">View →</span>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="text-center">
          <a
            href="/screenplays"
            className="inline-block px-8 py-3 border-2 border-primary text-primary font-semibold hover:bg-primary hover:text-primary-foreground transition-all duration-200 hover:scale-105"
          >
